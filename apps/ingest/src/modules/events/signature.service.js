...
let SignatureService = SignatureService_1 = class SignatureService {
    ...
    constructor(configService) {
        ...
        this.masterSecret = this.configService.get('HMAC_MASTER_SECRET', 'default-master-secret');
        this.timestampWindowMs = this.configService.get('TIMESTAMP_WINDOW_MS', 300000);
    }
    validateSignature(signature, timestamp, body, projectSecret) {
        try {
    ...
    generateSignature(body, projectSecret) {
